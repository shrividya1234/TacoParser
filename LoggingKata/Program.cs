    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
           ...
           double distance = 0;
            ...
            logger.LogInfo($"{tacoBellOne.Name} and {tacoBellTwo.Name} have the greatest distance between them which amount is {distance} meters, which is {Math.Round(distance * 0.00062)} miles");
